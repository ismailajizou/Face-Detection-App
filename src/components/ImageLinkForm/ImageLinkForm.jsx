...
const ImageLinkForm = ({ onInputChange, onBtnSubmit, loading }) => (
    <Flex flexDir='column' alignItems='center' py={6}>
        ...
        <Flex className='form' p={8} mt={6} borderRadius='2xl' w={["97%", "80%", "70%", "60%"]}>
            ...
            <Button colorScheme="purple" onClick={onBtnSubmit} isLoading={loading} loadingText='Detecting'>Detect</Button>
        </Flex>
    </Flex>
);
